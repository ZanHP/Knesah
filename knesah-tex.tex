...
Povejmo še, da za število vozlišč velja $|V(n,k)|={{n}\choose{k}}$. 
...
\indent Vzemimo množico točk $\{1,2,\ldots,2k+d\}$ in jih postaimo v splošno lego na sfero $S^{d+1}$. Naj bo $V(n,k)$ množica vseh $k$-elementnih podmnožic začetne množice, razdelimo jo na $d+1$ razredov, $V(n,k) = V_1 \sqcup V_2 \sqcup \ldots \sqcup V_{d+1}$. Naš cilj je najti par disjunktnih $k$-elementnih množic $A$ in $B$, ki pripadata istemu razredu $V_i$.
\newpage
