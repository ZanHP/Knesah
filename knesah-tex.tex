...
Za $i=1, 2,\ldots, d+1$ definirajmo $O_i = \{x \in S^{d+1}; \text{odprta polsfera } H_x \text{ z vrhom } x \text{ vsebuje } k\text{-elementno množico iz } V_i\}.$ %polepšati, da bo kot v besedilu
