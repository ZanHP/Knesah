...
\item $K(n,1)$ je poln graf za $n \in \mathbb{N}$

\pause
\item $K(2n,n)$ je enak $\frac{1}{2} {{2n}\choose{n}}$ kopijam potnega grafa $P_2$

\pause
\item število vozlišč $|V(n,k)|={{n}\choose{k}}$

\pause
\item $K(n,k)$ je regularen stopnje ${n-k}\choose{k}$

\end{enumerate}

\onslide
\begin{figure}[b]
\includegraphics[width=0.3\textwidth]{poln_graf}
